...
CREATE TABLE "coffee"(
  ...
  "description" TEXT,
  "img_reference" TEXT NOT NULL,
  "origin"VARCHAR(155) NOT NULL,
  "price" INT NOT NULL,
  "flavor_profile" VARCHAR(155) NOT NULL,
  "availability" VARCHAR(60) NOT NULL 
);

INSERT INTO "coffee"("name", "description", "img_reference", "origin", "price", "flavor_profile", "availability") VALUES 
...
('Jamaican Blue Mountain', 'Reconnu pour sa saveur douce, son acidité vive et son absence d''amertume.', '589100954', 'Jamaïque', 39.25, 'Acide', 'Oui'),
...
('Nicaraguan Maragogipe', 'Café avec des notes de fruits, une acidité vive et un corps plein.', '691550753', 'Nicaragua', 29.60, 'Fruité', 'Non');